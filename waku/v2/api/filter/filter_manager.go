...
func NewFilterManager(ctx context.Context, logger *zap.Logger, minPeersPerFilter int, onNewEnvelopes func(env *protocol.Envelope) error, node *filter.WakuFilterLightNode) *FilterManager {
...
*/
func (mgr *FilterManager) AddFilter(filterID string, cf protocol.ContentFilter) {
